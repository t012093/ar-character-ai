...
このプロジェクトでは、音声認識APIとしてOpenAI Whisperを採用します。
...
| API           | メリット                                                              | デメリット                                                              |
| ------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- |
| Azure Speech | リアルタイム音声認識に優れている、多言語対応が豊富、エンタープライズレベルのセキュリティと信頼性 | 比較的コストが高い、カスタマイズ性が低い                               |
| OpenAI Whisper | 高い認識精度、オープンソースでカスタマイズ性が高い、比較的コストが低い | リアルタイム音声認識には向かない、多言語対応はAzure Speechに劣る |
